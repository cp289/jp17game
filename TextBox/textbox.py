			...
			if event.type == pygame.KEYDOWN:
				...
				if event.key == pygame.K_c:
					if finished == True:
						finished = False
						sys.exit()
					textToBoxes(zena, "This is a textbox. We will use them for story events. Once the text gets too long, it will enter a new box. I need more to say so ummmmmmmmm.... enter the next box, please. Okay, is this good? Alright, looks like it worked. Next, someone else will talk. Enjoy.")
					textToBoxes(melody, "What am I doing here? I don't want to be here...I have to have a conversation to get out of here, right? Well...I'm Melody. Bugs beware!!! Goodbye!")
					textToBoxes(fatimah, "What are y'all doing? Seems fun. Malto bene! Lalala~ This was Fatimah. Thank you.")
					...
					textToBoxes(zena, "Thank you for watching. Bye!", True)
